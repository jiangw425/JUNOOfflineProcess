...
#     use ROOT v* Externals (no_version_directory)
#     use EDMUtil v* DataModel (no_version_directory)
# use PMTCalibSvc v* Calibration (no_version_directory)
#   use SniperKernel v*  (no_version_directory)
#   use ROOT v* Externals (no_version_directory)
#   use Boost v* Externals (no_version_directory)
#   use CondDB v* Calibration (no_version_directory)
#     use SniperKernel v*  (no_version_directory)
#     use Boost v* Externals (no_version_directory)
#     use CLHEP v* Externals (no_version_directory)
#     use ROOT v* Externals (no_version_directory)
#   use CondObj v* Calibration (no_version_directory)
#     use SniperPolicy v*  (no_version_directory)
#     use CondDB v* Calibration (no_version_directory)
#   use SniperRelease v*  (no_version_directory)
#
...
use Identifier v0 Detector (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
...
use CondDB v0 Calibration (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use CondObj v0 Calibration (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use Geometry v0 Detector (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use Context v0 DataModel (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use XmlObjDesc v0  (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline) (no_auto_imports)
use BaseEvent v0 DataModel (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use EDMUtil v0 DataModel (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use DataRegistritionSvc v0 DataModel (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use EvtNavigator v0 DataModel (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use RootIOUtil v0 RootIO (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use RootIOSvc v0 RootIO (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use BufferMemMgr v0 CommonSvc (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use CalibEvent v0 DataModel (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use ElecEvent v0 DataModel (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use CLHEPDict v0 DataModel/Dict (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
use RecEvent v0 DataModel (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
...
use PMTCalibSvc v0 Calibration (/cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline)
----------> tags
...
----------> CMTPATH
# Add path /cvmfs/juno.ihep.ac.cn/centos7_amd64_gcc830/Pre-Release/J21v1r0-Pre0/offline from initialization
