void calibHitTimebk(){
    ...
    string path[nf] = {
        ...
        // "/scratchfs/juno/jiangw/J22-rc0-calib/Laser0.1/step11/user-root/user-calib-0.root",
        // "/scratchfs/juno/jiangw/J22-rc1-calib/Laser0.1/step11/user-root/user-calib-0.root"
    };
    // const double timeShift[nf] = {100,300};
    const double timeShift[nf] = {0,0};
    string flags[nf] = {"rc0","rc1"};
