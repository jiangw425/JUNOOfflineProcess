...
void ckAngle()
{
    ...
    std::string paths[2] = {
//        "/junofs/production/data-production/Pre-Releases/J21v1r0-Pre2/0/e+_angle/0-10MeV/ENERGYMeV/detsim/user-root/user-detsim-",
//        "/junofs/production/data-production/Pre-Releases/J21v1r0-Pre2/1/e+_angle/0-10MeV/ENERGYMeV/detsim/user-root/user-detsim-"
