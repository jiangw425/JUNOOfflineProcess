...
bool script4()
{
  ...
  // FIXME merged files
  TFile* inputfile = new TFile("../Laser0.1/run_step4ex/user-root/user_calibCorr.root", "read");
  // TFile* inputfile2 = new TFile("/junofs/users/zhangxt/20inch/rec/deconvolution/runs/pars20200504/output_deconv.root", "read");
  TFile* inputfile2 = new TFile("../C14/run_step4ex/user-root/user_calibCorr.root", "read");
