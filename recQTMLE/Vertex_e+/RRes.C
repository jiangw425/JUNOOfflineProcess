...
void RRes() {
    ...
    grRM->GetYaxis()->SetTitle("Radial resolution [mm]");
    ...
    TLegendEntry* l1 = legend->AddEntry(vecGr[0],"e+","lp");
    l1->SetTextColor(EColor[0]);
    // TLegendEntry* l2 = legend->AddEntry(vecGr[1],"^{68}Ge+ rec.e-","lp");
