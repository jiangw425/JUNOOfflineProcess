...
do
    ...
    do
        ...
        echo "(time python ../tut_calib2rec.py --JOBA ${n} --JOBB $[$n+1] --PMTtype 1 --SignalWindow SIGNALWINDOW --RfrIndxLS 1.54 --RfrIndxWR 1.355 --calibdir ACUCLSPATH --usercalibdir ACUCLSPATH --paradir ${mytop}/data/Calibration/PMTCalibSvc/data --calibsource $s --startseed 0 --filenum FILENUM) >& log/pdflog-${n}.txt" >> $job_name
